...
<head>
    <meta charset="UTF-8">
    <title><?php echo Language::get('user_management', $lang); ?> - SmartSHOP</title>
...
<body>
    <div class="dashboard-container">
        ...
        <header class="header">
            <h1>👥 <?php echo Language::get('user_management', $lang); ?></h1>
        </header>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($u['user_id'] != $user['user_id']): ?>
                                        <button onclick="deleteUser(<?php echo $u['user_id']; ?>)" class="btn-small btn-danger"><?php echo Language::get('delete', $lang); ?></button>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>
